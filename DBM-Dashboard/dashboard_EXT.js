module.exports = {
    ...
    */
    ...
    mod: async function (DBM) {
        ...
        const express = await DBM.require("express", "dashboard_EXT"),
            bodyParser = await DBM.require("body-parser", "dashboard_EXT"),
            cookieParser = await DBM.require('cookie-parser', "dashboard_EXT"),
            ejs = await DBM.require('ejs', "dashboard_EXT"),
            Strategy = await DBM.require('passport-discord', "dashboard_EXT"),
            session = await DBM.require('express-session', "dashboard_EXT"),
            path = await DBM.require('path', "dashboard_EXT"),
            passport = await DBM.require('passport', "dashboard_EXT"),
            chalk = await DBM.require("chalk", "dashboard_EXT"),
            figlet = await DBM.require("figlet", "dashboard_EXT"),
